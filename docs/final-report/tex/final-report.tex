...
\begingroup
\centering
\includegraphics[width=0.9\linewidth]{./img/backend_backlog.jpg}
...
\begingroup
\centering
\includegraphics[width=0.9\linewidth]{./img/frontend_backlog.jpg}
...
\vspace{\vspaceconst}
\NOTE mainly for the backend nodejs with typescript was used\\
... talk about why this stack was chosen\\
... then talk about expres\\
... mongoose vs clean mongo \\

\NOTE talk about writting fl-auth in go and why\\


\subsubsection{Micro service split}
\vspace{\vspaceconst}
\NOTE fl-tp could have also been split into two parts
